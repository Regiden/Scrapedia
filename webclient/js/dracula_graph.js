...
Graph.Node = function (id, node) {
    ...
    node.hide = function () {
        ...
        /* FIXME this is representation specific code and should be elsewhere */
        for (i in this.edges)
...
Graph.Renderer.Raphael = function (element, graph, width, height) {
    ...
    this.dragger = function (e) {
        ...
        this.dy = e.clientY;
        selfRef.isDrag = this;
        this.set && this.set.animate({"fill-opacity": .4}, 200) && this.set.toFront();
...
Graph.Renderer.Raphael.prototype = {
    ...
    draw: function () {
        if (this.graph.fixedFactor) {
            this.factorX = this.graph.fixedFactor;
            this.factorY = this.graph.fixedFactor;
        } else {
...
Graph.Layout.Fixed = function (graph, fixFactor) {
    this.graph = graph;
    this.graph.fixedFactor = fixFactor || 1;
    this.layout();
};
